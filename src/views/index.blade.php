...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('Jeylabs.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data'>
  ...
  <!-- <script>{!! \File::get(base_path('vendor/Jeylabs/laravel-filemanager/public/js/script.js')) !!}</script> -->
</body>
</html>
